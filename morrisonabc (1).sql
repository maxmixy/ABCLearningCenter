...
('00000000000', 'Sample book', 'Yuri Morrison', 'This is a sample book, trying to test the add book function', 'yes, this is a description', 'Morrison Books Inc.', '2024', 'Databases', 9999999.00),
('0324785151', 'test', 'test', 'test', 'test', 'test', '2022', 'Databases', 2000.00),
...
('1401889948', 'Collision Repair And Refinishing test', 'Alfred Thomas and Michael Jund', 'This new book covers all the necessary tasks for gaining knowledge of collision repair and refinishing as outlined by NATEF. In-depth coverage includes structural and non-structural analysis and damage repair, welding, painting and refinishing, paint chem', 'Softbound with CD', 'Published by Delmar Learning', '2010', 'Automotive', 100.00),
...
('test', 'test', 'test', 'test', 'test', 'test', '2022', 'Databases', 90.00);
...
('3', 5, '2024-10-09', '00000000000', 0, ''),
('3', 5, '2024-10-09', '0324785151', 0, ''),
('3', 6, '2024-10-07', '0534952852', 0, ''),
('3', 7, '2024-10-08', '00000000000', 1, ''),
('3', 7, '2024-10-08', '0324785151', 0, ''),
('3', 7, '2024-10-08', '0534493033', 0, ''),
('1', 8, '2024-10-10', '0534952852', 0, ''),
('1', 10, '2024-10-10', '00000000000', 0, ''),
('1', 20, '2024-10-10', '00000000000', 0, ''),
('1', 20, '2024-10-10', '0534493033', 0, ''),
('1', 20, '2024-10-10', '0534525784', 0, ''),
('3', 21, '2024-10-10', '00000000000', 0, ''),
('3', 21, '2024-10-10', '0534493033', 0, '');
...
--
ALTER TABLE `borrowtran`
  MODIFY `TransactionNo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
-- Events
--
CREATE DEFINER=`root`@`localhost` EVENT `delete_expired_reservations` ON SCHEDULE EVERY 1 DAY STARTS '2024-10-10 02:09:30' ON COMPLETION NOT PRESERVE ENABLE DO BEGIN
  DELETE FROM reservetran
  WHERE DateReserved < (CURDATE() - INTERVAL 1 DAY);
END$$
